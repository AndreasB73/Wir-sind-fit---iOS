...
//  Wir sind fit!
//
//  Created by Andreas Bachmaier on 16.11.17.
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "Youtube" {
            ...
            destVC.title = segue.identifier
            destVC.webUrl = URL(string: "https://www.youtube.com/channel/UCiGuXy8BLRRTmDqjvwQCocA")
        }
        if segue.identifier == "Twitter" {
            let destVC = segue.destination as! WebsiteViewController
            destVC.title = segue.identifier
            destVC.webUrl = URL(string: "https://twitter.com/Wir_sind_fit")
        }
    }
